...
#
#    
    lista=os.listdir('Signos LSCH')
#    while(True):
#        for i in range(24):
#            print(type(lista[i]))
#            letrica = cv2.imread('Signos LSCH/'+ lista[i])
...
#        cv2.imshow("Signos", '.jpg')
        ...
        if keypress2 == ord(" "):
            letrica=lista[np.random.randint(20)]
            letraimagen=cv2.imread('Signos LSCH/'+ letrica)
